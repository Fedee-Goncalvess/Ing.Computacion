...
Procedure CalcularMax (a:paciente; var dni:longint; var nombreApellido:string;var cant:integer);
var
    tot:integer;
begin
    tot:=0;
...
Procedure buscarMaxPaciente(a:arbol; var dni:longint; var nombreApellido:string;var cant:integer);
begin
    if(a<>nil)then
    begin
      CalcularMax (a^.dato,dni,nombreApellido,cant);
      buscarMaxPaciente(a^.HI,dni,nombreApellido,cant);
      buscarMaxPaciente(a^.HD,dni,nombreApellido,cant);
    end;
end;
...
begin
  cant:=-1;
  buscarMaxPaciente (a,dni,nombreApellido,cant);
end;
{-------------------------------------------------}
