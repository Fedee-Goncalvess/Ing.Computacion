...
public class crearClase {
    public static void main (String[] args){
        ...
        for (int i=0;i<cantidad; i++){
            System.out.print(vectorS[i][0]+" "+"un"+vectorS[i][1]);
        ...
        for (int i=0;i<cantidad; i++){
            //Set
            System.out.println("public void set"+ capitalize(vectorS[i][1]) + "(" +vectorS[i][0] +" "+"un"+vectorS[i][1] + "){");
            System.out.println("this."+vectorS[i][1]+ " = " +"un"+vectorS[i][1]+";");
            System.out.println("}");
            System.out.println();
